...
void *create_timer(call_t *c, void *callback_function, void *conditional_end,
    ...
    /* edited by Fabrice Theoleyre <theoleyre@unistra.fr> */
    timer->callback_function = (void (*)(call_t *, void *))callback_function;
    timer->conditional_end = (int (*)(call_t *, void *)) conditional_end;
    timer->next_trigger = (uint64_t (*)(call_t *, void *))next_trigger;
    /* end of edition */
