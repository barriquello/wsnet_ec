...
int rng_type(char *rng) {
    ...
    if (strcmp(rng, "mt19937") == 0) {
         ...
         * developed by Lascher. It uses a lagged-fibonacci-with-skipping algorithm
         ...
         * The default level of decorrelation recommended by Lascher is provided by
...
void rng_clean(void) {
    /* edit by Fabrice Theoleyre <theoleyre@unistra.fr> */
    void *i = NULL;
